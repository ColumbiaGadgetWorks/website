...
subtitle: Short, because we collect very little.
...
**Nothing, by default.** The site is a set of static pages. It sets no cookies of its own, has no user accounts, and does not use advertising trackers.
...
Some pages include content from other services. When you interact with them, those services may collect data under their own policies:
...
Information about members (contact details, waiver, training records, dues status) is kept in our member records system and on the member wiki, and is available only to the officers and volunteers who need it to run the shop. Members can ask to see or correct their information at any time.

## Donor privacy

We do not sell, trade, or share our donors' names or contact information with anyone. Donor names are published only with the donor's permission.
...
We'll post any changes to this policy here with a new date. Questions: [mail@columbiagadgetworks.org](mailto:mail@columbiagadgetworks.org) or Columbia Gadget Works, 1404 Grand Ave, Columbia, MO 65203.
