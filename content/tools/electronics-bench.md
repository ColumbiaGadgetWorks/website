...
**What people do here:** learn to solder, fix broken gadgets (the original reason this place exists), build kits, program microcontrollers, design PCBs, and reverse-engineer things they were curious about.
...
No formal training required; a member will show you the stations and where things live. Please:

- Return components and tools to their bins.
